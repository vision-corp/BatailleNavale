...
public class BatailleNavale {
    ...
    public static void main (String[] args) {
        ...
        b1.setProu(new Coordonnee(1, 'A'));
        b1.setSens(2); // sud
        b2.setProu(new Coordonnee(8, 'B'));
        b2.setSens(1); // Est 
        b3.setProu(new Coordonnee(2, 'E'));
        b3.setSens(1); // Est
        b4.setProu(new Coordonnee(10, 'D'));
        b4.setSens(1); // Est 
        b5.setProu(new Coordonnee(4, 'C'));
        b5.setSens(3); // Ouest
        b6.setProu(new Coordonnee(3, 'H'));
        b6.setSens(1); // Est 
        b7.setProu(new Coordonnee(12, 'E'));
        b7.setSens(2); // sud
        b8.setProu(new Coordonnee(12, 'K'));
        b8.setSens(1); // Est 
        b9.setProu(new Coordonnee(3, 'K'));
        b9.setSens(2); // sud
        b10.setProu(new Coordonnee(2, 'J'));
        b10.setSens(1); // Est
